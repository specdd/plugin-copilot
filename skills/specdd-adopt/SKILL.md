---
name: specdd-adopt
description: Use when GitHub Copilot needs to add SpecDD to a project or update SpecDD framework files through the CLI before normal SpecDD work begins.
license: Apache-2.0
---
